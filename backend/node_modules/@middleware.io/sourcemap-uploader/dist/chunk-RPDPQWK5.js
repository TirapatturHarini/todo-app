...
var PathScurryWin32 = class extends PathScurryBase {
  constructor(cwd2 = process.cwd(), opts = {}) {
    ...
    super(cwd2, win32, "\\", __spreadProps(__spreadValues({}, opts), { nocase }));
    /**
     * separator for generating path strings
     */
    __publicField(this, "sep", "\\");
...
var PathScurryPosix = class extends PathScurryBase {
  constructor(cwd2 = process.cwd(), opts = {}) {
    ...
    super(cwd2, posix, "/", __spreadProps(__spreadValues({}, opts), { nocase }));
    /**
     * separator for generating path strings
     */
    __publicField(this, "sep", "/");
  ...
  return __async(this, arguments, function* (paths, { allowNoop }) {
    ...
    yield Promise.all(
      paths.map((path2) => __async(this, null, function* () {
        const realPath = isAbsolute(path2) ? path2 : join(cwd(), path2);
...
//# sourceMappingURL=chunk-RPDPQWK5.js.map