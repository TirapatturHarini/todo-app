...
var _AST = class {
  ...
  static fromGlob(pattern, options = {}) {
    ...
    __privateMethod(_a4 = _AST, _parseAST, parseAST_fn).call(_a4, pattern, ast, 0, options);
    return ast;
  }
  ...
  toRegExpSource() {
    ...
    if (!this.type) {
      ...
      const src = __privateGet(this, _parts).map((p) => {
        var _a5;
        const [re, _, hasMagic2, uflag] = typeof p === "string" ? __privateMethod(_a5 = _AST, _parseGlob, parseGlob_fn).call(_a5, p, __privateGet(this, _hasMagic), noEmpty) : p.toRegExpSource();
...
var _max, _maxSize, _dispose, _disposeAfter, _fetchMethod, _memoMethod, _size, _calculatedSize, _keyMap, _keyList, _valList, _next, _prev, _head, _tail, _free, _disposed, _sizes, _starts, _ttls, _hasDispose, _hasFetchMethod, _hasDisposeAfter, _initializeTTLTracking, initializeTTLTracking_fn, _updateItemAge, _statusTTL, _setItemTTL, _isStale, _initializeSizeTracking, initializeSizeTracking_fn, _removeItemSize, _addItemSize, _requireSize, _indexes, indexes_fn, _rindexes, rindexes_fn, _isValidIndex, isValidIndex_fn, _a2, _evict, evict_fn, _backgroundFetch, backgroundFetch_fn, _isBackgroundFetch, isBackgroundFetch_fn, _connect, connect_fn, _moveToTail, moveToTail_fn, _delete, delete_fn, _clear, clear_fn;
var _LRUCache = class {
  constructor(options) {
  ...
  *rvalues() {
  ...
  memo(k, memoOptions = {}) {
    ...
    const _a4 = memoOptions, { context, forceRefresh } = _a4, options = __objRest(_a4, ["context", "forceRefresh"]);
...
var Minipass = class extends import_node_events.EventEmitter {
   ...
   */
  get [(_a3 = FLOWING, _b = PAUSED, _c = PIPES, _d = BUFFER, _e = OBJECTMODE, _f = ENCODING, _g = ASYNC, _h = DECODER, _i = EOF, _j = EMITTED_END, _k = EMITTING_END, _l = CLOSED, _m = EMITTED_ERROR, _n = BUFFERLENGTH, _o = DESTROYED, _p = SIGNAL, _q = ABORTED, _r = DATALISTENERS, _s = DISCARDED, "async")]() {
    return this[ASYNC];
  }
  /**
...
var PathBase = class {
  ...
  resolve(path2) {
    ...
    const result = rootPath ? __privateMethod(_a4 = this.getRoot(rootPath), _resolveParts, resolveParts_fn).call(_a4, dirParts) : __privateMethod(this, _resolveParts, resolveParts_fn).call(this, dirParts);
    return result;
  }
  /**
  ...
  readlink() {
    return __async(this, null, function* () {
      ...
      try {
        const read = yield __privateGet(this, _fs).promises.readlink(this.fullpath());
        const linkTarget = (_a4 = yield this.parent.realpath()) == null ? void 0 : _a4.resolve(read);
        if (linkTarget) {
  ...
  lstat() {
    return __async(this, null, function* () {
      if ((__privateGet(this, _type) & ENOENT) === 0) {
        try {
          __privateMethod(this, _applyStat, applyStat_fn).call(this, yield __privateGet(this, _fs).promises.lstat(this.fullpath()));
          return this;
        } catch (er) {
  ...
  readdir() {
    return __async(this, null, function* () {
      ...
      if (__privateGet(this, _asyncReaddirInFlight)) {
        yield __privateGet(this, _asyncReaddirInFlight);
      } else {
        let resolve = () => {
        };
        __privateSet(this, _asyncReaddirInFlight, new Promise((res) => resolve = res));
        try {
          for (const e of yield __privateGet(this, _fs).promises.readdir(fullpath, {
            withFileTypes: true
          })) {
            __privateMethod(this, _readdirAddChild, readdirAddChild_fn).call(this, e, children);
          }
  ...
  realpath() {
    return __async(this, null, function* () {
      ...
      if ((ENOREALPATH | ENOREADLINK | ENOENT) & __privateGet(this, _type))
        return void 0;
      try {
        const rp = yield __privateGet(this, _fs).promises.realpath(this.fullpath());
...
readdirSuccess_fn = function(children) {
  ...
  for (let p = children.provisional; p < children.length; p++) {
    const c = children[p];
    if (c)
      __privateMethod(_a4 = c, _markENOENT, markENOENT_fn).call(_a4);
  }
};
...
markChildrenENOENT_fn = function() {
  ...
  children.provisional = 0;
  for (const p of children) {
    __privateMethod(_a4 = p, _markENOENT, markENOENT_fn).call(_a4);
  }
};
...
lstatFail_fn = function(code = "") {
  ...
  if (code === "ENOTDIR") {
    const p = this.parent;
    __privateMethod(_a4 = p, _markENOTDIR, markENOTDIR_fn).call(_a4);
  } else if (code === "ENOENT") {
    __privateMethod(this, _markENOENT, markENOENT_fn).call(this);
  }
};
...
readlinkFail_fn = function(code = "") {
  ...
  if (code === "ENOTDIR" && this.parent) {
    __privateMethod(_a4 = this.parent, _markENOTDIR, markENOTDIR_fn).call(_a4);
  }
};
...
var PathScurryBase = class {
  ...
  constructor(cwd2 = process.cwd(), pathImpl, sep2, { nocase, childrenCacheSize = 16 * 1024, fs = defaultFS } = {}) {
    ...
    if (cwd2 instanceof URL || cwd2.startsWith("file://")) {
      cwd2 = (0, import_node_url.fileURLToPath)(cwd2);
    }
  ...
  readdir() {
    return __async(this, arguments, function* (entry = this.cwd, opts = {
      withFileTypes: true
    }) {
      if (typeof entry === "string") {
        entry = this.cwd.resolve(entry);
   ...
   */
  lstat() {
    return __async(this, arguments, function* (entry = this.cwd) {
      if (typeof entry === "string") {
        entry = this.cwd.resolve(entry);
      }
      return entry.lstat();
  ...
  readlink() {
    return __async(this, arguments, function* (entry = this.cwd, { withFileTypes } = {
      withFileTypes: false
    }) {
      if (typeof entry === "string") {
        entry = this.cwd.resolve(entry);
...
var PathScurryWin32 = class extends PathScurryBase {
  constructor(cwd2 = process.cwd(), opts = {}) {
    ...
    super(cwd2, import_node_path.win32, "\\", __spreadProps(__spreadValues({}, opts), { nocase }));
    /**
     * separator for generating path strings
     */
    __publicField(this, "sep", "\\");
...
var PathScurryPosix = class extends PathScurryBase {
  constructor(cwd2 = process.cwd(), opts = {}) {
    ...
    super(cwd2, import_node_path.posix, "/", __spreadProps(__spreadValues({}, opts), { nocase }));
    /**
     * separator for generating path strings
     */
    __publicField(this, "sep", "/");
...
var PathScurryDarwin = class extends PathScurryPosix {
  constructor(cwd2 = process.cwd(), opts = {}) {
    const { nocase = true } = opts;
    super(cwd2, __spreadProps(__spreadValues({}, opts), { nocase }));
  }
};
...
var Minipass2 = class extends import_stream.default {
  constructor(options) {
    super();
    this[FLOWING2] = false;
    this[PAUSED2] = false;
  ...
  static isStream(s) {
    return !!s && (s instanceof Minipass2 || s instanceof import_stream.default || s instanceof import_events.default && // readable
...
var GlobUtil = class {
  ...
  matchCheck(e, ifDir) {
    return __async(this, null, function* () {
      ...
      return this.matchCheckTest(needStat ? yield e.lstat() : e, ifDir);
    });
  }
  ...
  match(e, absolute, ifDir) {
    return __async(this, null, function* () {
      const p = yield this.matchCheck(e, ifDir);
      if (p)
...
ignored_fn = function(path2) {
  var _a4, _b2;
  return this.seen.has(path2) || !!((_b2 = (_a4 = __privateGet(this, _ignore)) == null ? void 0 : _a4.ignored) == null ? void 0 : _b2.call(_a4, path2));
};
_childrenIgnored = new WeakSet();
childrenIgnored_fn = function(path2) {
  var _a4, _b2;
  return !!((_b2 = (_a4 = __privateGet(this, _ignore)) == null ? void 0 : _a4.childrenIgnored) == null ? void 0 : _b2.call(_a4, path2));
};
...
var Glob = class {
  ...
  walk() {
    return __async(this, null, function* () {
      return [
        ...yield new GlobWalker(this.patterns, this.scurry.cwd, __spreadProps(__spreadValues({}, this.opts), {
...
function glob(_0) {
  return __async(this, arguments, function* (pattern, options = {}) {
...
function getAllSourceMapFiles(_0, _1) {
  return __async(this, arguments, function* (paths, { allowNoop }) {
    const map = [];
    yield Promise.all(
      paths.map((path2) => __async(this, null, function* () {
        const realPath = (0, import_path.isAbsolute)(path2) ? path2 : (0, import_path.join)((0, import_process.cwd)(), path2);
        if ((0, import_fs2.statSync)(realPath).isFile()) {
          map.push({
            path: realPath,
        ...
        if (!allowNoop && !globSync("**/*.{js,css}.map", {
          cwd: realPath,
          nodir: true,
          ignore: "**/node_modules/**/*"
        }).length) {
        ...
        for (const file of globSync("**/*.{js,css}.map", {
          ...
          map.push({
            path: (0, import_path.join)(realPath, file),
            name: file
          });
...
function uploadFile(filePath, uploadUrl, name) {
  return __async(this, null, function* () {
    ...
    const res = yield (0, import_cross_fetch.default)(uploadUrl, {
      method: "put",
      headers: {
...
var makeFetch = (url, apiKey, type, body) => __async(void 0, null, function* () {
  const response = yield (0, import_cross_fetch.default)(url, {
    method: type,
    headers: {
...
var uploadSourcemaps = (_0) => __async(void 0, [_0], function* ({
  ...
  try {
    ...
    const backend = backendUrl || "https://app.middleware.io/api/v1/rum/getSasUrl";
    console.info(`Starting to upload source maps from ${path2}`);
    const fileList = yield getAllSourceMapFiles([path2], { allowNoop });
    if (fileList.length === 0)
      throw new Error(
        `Error: No source maps found in ${path2}, is this the correct path?`
      );
    const res = yield makeFetch(backend, apiKey, "POST", {
      fileNames: fileList.map(({ name }) => getBucketKey(basePath || "", name)),
      version: appVersion != null ? appVersion : "latest"
    });
    if (!(res == null ? void 0 : res.status) || !(res == null ? void 0 : res.data) || ((_a4 = res.data) == null ? void 0 : _a4.length) === 0)
      throw new Error("Error: Unable to generate source map upload urls.");
    yield Promise.all(
      fileList.map(
        ({ path: path3, name }, idx) => uploadFile(path3, res.data[idx], name)
      )
    );
    if (deleteAfterUpload) {
      yield Promise.all(
        fileList.map(({ path: path3, name }, idx) => {
          if (path3.endsWith(".map")) {
            (0, import_promises2.unlink)(path3);
          }
        })
      );
    }
...
function getBucketKey(basePath, fileName) {
  const normalizedFilename = fileName.replace(/[()]/g, "");
  return `${basePath}${normalizedFilename}`;
}

// src/index.ts
import_commander.program.name("@middleware.io/sourcemap-uploader").version("0.1.6").description("Upload Javascript sourcemaps to Middleware");
import_commander.program.command("upload").requiredOption("-k, --apiKey <string>", "The Middleware rum api key").option("-av, --appVersion [string]", "The current version of your deploy").option(
  "-p, --path [string]",
