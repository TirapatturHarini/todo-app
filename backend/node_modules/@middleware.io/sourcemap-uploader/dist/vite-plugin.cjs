...
var PathScurryBase = class {
   ...
   * @internal
   */
  constructor(cwd3 = process.cwd(), pathImpl, sep2, { nocase, childrenCacheSize = 16 * 1024, fs = defaultFS } = {}) {
    /**
...
var PathScurryWin32 = class extends PathScurryBase {
  constructor(cwd3 = process.cwd(), opts = {}) {
    ...
    super(cwd3, import_node_path.win32, "\\", __spreadProps(__spreadValues({}, opts), { nocase }));
    /**
     * separator for generating path strings
     */
    __publicField(this, "sep", "\\");
...
var PathScurryPosix = class extends PathScurryBase {
  constructor(cwd3 = process.cwd(), opts = {}) {
    ...
    super(cwd3, import_node_path.posix, "/", __spreadProps(__spreadValues({}, opts), { nocase }));
    /**
     * separator for generating path strings
     */
    __publicField(this, "sep", "/");
...
var PathScurryDarwin = class extends PathScurryPosix {
  constructor(cwd3 = process.cwd(), opts = {}) {
    const { nocase = true } = opts;
    super(cwd3, __spreadProps(__spreadValues({}, opts), { nocase }));
  }
};
  ...
  return {
    ...
    closeBundle() {
      return __async(this, null, function* () {
        var _a5;
        try {
          const outDir = (0, import_path2.resolve)(resolvedConfig.root, resolvedConfig.build.outDir);
          const path2 = (_a5 = options.path) != null ? _a5 : (0, import_path2.relative)((0, import_process2.cwd)(), outDir) || ".";
