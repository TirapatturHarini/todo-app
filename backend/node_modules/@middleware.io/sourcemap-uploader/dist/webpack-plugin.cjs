...
__export(webpack_plugin_exports, {
  default: () => MiddlewareWebpackPlugin
});
...
// src/webpack-plugin.ts
var MiddlewareWebpackPlugin = class {
  constructor(apiKey, appVersion, path2, basePath, backendUrl, deleteAfterUpload) {
    this.apiKey = apiKey;
  ...
  apply(compiler) {
    compiler.hooks.afterEmit.tap("MiddlewareWebpackPlugin", () => __async(this, null, function* () {
      try {
